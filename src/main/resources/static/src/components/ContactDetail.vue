  ...
  <form>
    <div class="row">
      <div class="col">
        ...
        <input id="givenName" ref="contactDetailGivenName" type="text" placeholder="Given Name" class="form-control" v-model="contact.givenName" tabindex="1" />
      ...
      <div class="col">
        ...
        <input id="surname" type="text" placeholder="Surname" class="form-control" v-model="contact.surname" tabindex="3" />
        <div style="color: red;" v-if="v$.contact.givenName.$error">Required</div>
      </div>
      <div class="col">
        <label for="suffix">Suffix:</label>
        <input id="suffix" type="text" placeholder="Suffix" class="form-control" v-model="contact.suffix" tabindex="4" />
      </div>
    </div>
    <div class="row">
